...
| Cloud storage (CDN) | Qiniu, OSS, LeanCloud, Bmob, Shoot the clouds again, S3 |
| Mobile push | Jiguang, Umeng, Baidu |
| Instant messaging | Huanxin, Rongyun |
| SMS service | Yunpian, Jiguang, Luosimao, Shoot the clouds again |
| Third-party login | Umeng, ShareSDK |
| Website monitoring and statistics | Aliyun Monitoring, Surveillance treasure, Baidu Cloud Observation, Xiaoniaoyun |
